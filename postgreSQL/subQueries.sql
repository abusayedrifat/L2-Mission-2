...
--retrieve all employees whoes salary is greater than the hieght salary of the HR department
...
(SELECT  max(salary) FROM employees WHERE department_name = 'HR')  ORDER BY salary ASC;
